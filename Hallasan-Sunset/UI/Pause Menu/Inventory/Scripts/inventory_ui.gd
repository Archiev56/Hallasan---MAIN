...
@onready var inventory_slot_Mask: InventorySlotUI = %InventorySlot_Mask
@onready var inventory_slot_Hat: InventorySlotUI = %InventorySlot_Hat
...
func update_inventory( apply_focus : bool = true ) -> void:
	...
	inventory_slot_Mask.set_slot_data( e_slots[ 4 ] )
	inventory_slot_Hat.set_slot_data( e_slots[ 5 ] )

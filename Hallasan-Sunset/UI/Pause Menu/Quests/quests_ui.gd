...
@onready var details_container: VBoxContainer = $Panel2/VBoxContainer
@onready var title_label: Label = $Panel2/VBoxContainer/TitleLabel
@onready var description_label: Label = $Panel2/VBoxContainer/DescriptionLabel

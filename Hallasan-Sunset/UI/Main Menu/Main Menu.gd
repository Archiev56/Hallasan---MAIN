...
@onready var button_new: Button = $CanvasLayer/Control/PanelContainer/VBoxContainer/ButtonNew
@onready var button_continue: Button = $CanvasLayer/Control/PanelContainer/VBoxContainer/ButtonContinue

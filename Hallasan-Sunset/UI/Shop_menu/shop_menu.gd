...
const ERROR = preload("res://Hallasan-Sunset/npc/Characters/Act 1/Shopkeeper/Audio/error.wav")
const OPEN_SHOP = preload("res://Hallasan-Sunset/npc/Characters/Act 1/Shopkeeper/Audio/open_shop.wav")
const PURCHASE = preload("res://Hallasan-Sunset/npc/Characters/Act 1/Shopkeeper/Audio/purchase.wav")

const SHOP_ITEM_BUTTON = preload("res://Hallasan-Sunset/UI/Shop_menu/shop_items_button.tscn")

signal shown
signal hidden

var currency : ItemData = preload("res://Hallasan-Sunset/Items/Currency/Gem/Gem.tres")
...
@onready var gems_animation_player: AnimationPlayer = $Control/Panel2/PanelContainer/AnimationPlayer
